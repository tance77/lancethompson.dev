// ============================================================
//  Portfolio content. Ported from the mockup's window.PORTFOLIO_DATA
//  (the original data.js was not included in the mockup, so this
//  reconstructs the shape every component consumes).
// ============================================================
...
export const PORTFOLIO_DATA: Portfolio = {
    ...
    skills: [
        {
            group: "Front-end",
            items: ["TypeScript", "Vue.js", "Astro", "Javascript", "Vite"],
        },
        {
            group: "Back-end",
    ...
    projects: [
        {
            ...
            blurb:
                "A cross-platform Salesforce Data Loader — bulk CSV uploads, an object browser, and auto column mapping that persists across sessions, with zero JVM to install.",
            problem:
            ...
            features: [
                "Bulk CSV import/export — no JVM required",
        ...
        },
        {
            ...
            blurb:
                "A non-intrusive productivity tracker — surfaces focus and activity trends without screenshots or invasive monitoring. Rebuilt from Electron to Tauri for a lighter, native footprint.",
            problem:
                "Most time-tracking tools are surveillance ware — screenshots, invasive monitoring, constant nagging. People wanted insight into their own work patterns without feeling watched.",
            features: [
    ...
    posts: [
        {title: "Porting our Electron app to Tauri", date: "2026 · 04", read: "8 min"},
        {title: "Building a cross-platform Salesforce Data Loader", date: "2026 · 02", read: "11 min"},
        {title: "Terraform patterns Aurora", date: "2025 · 11", read: "9 min"},
    ],
};
